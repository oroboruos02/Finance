...
<div class="item"></div>
    ...
    <form action="n_persona.php" method="POST">
         <span class="p1">Identificación</span>
        <input type="number" name="id"class="p2" value="" required></input>
        <br>
        <span class="p1">Nombres</span>
        <input name="nombres" class="p2" value="" required></input>
        <br>
        <span class="p1">Apellidos</span>
        <input name="apellidos" class="p2" value="" required></input>
        <br>
        <span class="p1">Telefono</span>
        <input name="telefono" class="p2"  value="" required></input>
        <br>
        <span class="p1">Email</span>
        <input name="email" class="p2" value="" required></input>
        <br>
        <span class="p1">Contraseña</span>
        <input type="password"name="pass1" class="p2" value="" required></input>
        <br>
        ...
        <br>
        <span class="p1">Rol</span>
        <select name="rol" CLASS="p2">
            <option CLASS="p2" value="2">Usuario</option>
            <option CLASS="p2" value="1">Administrador</option>
