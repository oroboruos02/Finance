...
<body> 
    ...
    <div class="respmenu">
        ...
        <nav>
          <ul>
            <a href styles="border: 1px solid #000;"><img class="icons1" src="images/icons/dashboard.png">Dashboard</a>
            <li><a href="tabla1.php" target="frame1"><img class="icons1" src="images/icons/cuenta.png"><div class="mobile1">Mis cuentas</div></a></li>
            <li><a href="solicitud.php" target="frame1"><img class="icons1" src="images/icons/mis_productos.png"><div class="mobile1">Prestamos</div></a></li>
            <li><a href="personal.php" target="frame1"><img class="icons2" src="images/icons/configuracion.png"><div class="mobile1">Configuración</div></a></li>
    ...
    <div class="cabecera">
        ...
        <div class="hello">
          ...
          <span class="tamaño-texto" style="font-size:.7em;">Welcome back to dashboard</span>
        </div>
