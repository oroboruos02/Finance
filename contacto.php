...
include_once "conexion/conexion.php";
    $sent1 = $base_de_datos->prepare("SELECT * from empresa Where ?;");
    $sent1->execute([1]);
        ...
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
            <div class="flex gap-x-4">
              ...
              <dd><?php echo $sentencia_1->direccion?> <br></dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="tel:+1 (555) 234-5678"><?php echo $sentencia_1->telefono?></a></dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="mailto:hello@example.com"><?php echo $sentencia_1->email?></a></dd>
            </div>
          </dl>
        </div>
      </div>
      <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
          ...
          <div class="mt-8 flex justify-end">
            <button type="submit" class="rounded-md bg-gray-950 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:text-yellow-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send message</button>
          </div>
        </div>
      </form>
    </div>
